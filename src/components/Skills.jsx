    ...
    <section className="relative py-24 px-6">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          className="absolute w-[500px] h-[500px] bg-blue-500/20 rounded-full blur-[120px] top-[-100px] left-[10%]"
        />
        ...
        <motion.div
          ...
          className="absolute w-[400px] h-[400px] bg-cyan-400/20 rounded-full blur-[120px] bottom-[-100px] right-[10%]"
        />
